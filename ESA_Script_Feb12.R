...
#October 2023
#Research question: Do environmental variables influence aquatic insect communities in vernal ponds?
...
##Username - masward -> Repository -> Aquatic-Vernal-2023 
environmental_df <- read.csv("https://raw.githubusercontent.com/masward/Aquatic-Vernal-2023/main/Vernal_Pond_Datasheet_Oct102023.csv")
macro.df <- read.csv("https://raw.githubusercontent.com/masward/Aquatic-Vernal-2023/main/macroinvertebrate_datasheet_oct30.csv")
...
rr.plot <- read.csv("https://raw.githubusercontent.com/masward/Aquatic-Vernal-2023/main/repl_rich_oct30.csv")
...
ggplot(data = avg_environmental, aes(x = SITE_ID, y = avg_NITRATE_mg_L, fill = SITE_ID)) +
  geom_bar(stat="identity", color="black", position=position_dodge()) +
  scale_fill_manual(values = c("#E5F5F9", "#E5F5F9", "#E5F5F9", "#D4B9DA","#D4B9DA", "#D4B9DA","#D9D9D9", "#D9D9D9")) +
  ylab("Nitrate mg_L") +
  xlab("Site identification") +
  fig.theme

ggplot(data = avg_environmental, aes(x = SITE_ID, y = avg_PHOSPHATE_mg_L, fill = SITE_ID)) +
  geom_bar(stat="identity", color="black", position=position_dodge()) +
  scale_fill_manual(values = c("#E5F5F9", "#E5F5F9", "#E5F5F9", "#D4B9DA","#D4B9DA", "#D4B9DA","#D9D9D9", "#D9D9D9")) +
  ylab("Phosphate mg_L") +
  xlab("Site identification") +
